...
"""
openedx-sdk documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx-sdk',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/openedx-sdk",
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Python SDK for Open edX REST APIs',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_sdk'),
                os.path.join(root_path, 'openedx_sdk/migrations')])
