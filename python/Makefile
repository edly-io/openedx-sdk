...
quality: ## check coding style with pycodestyle and pylint
	...
	pylint openedx_sdk tests test_utils *.py
	rm tests/__init__.py
	pycodestyle openedx_sdk tests  *.py
	pydocstyle openedx_sdk tests *.py
	isort --check-only --diff tests test_utils openedx_sdk *.py test_settings.py
