#!/usr/bin/env python
"""
Package metadata for openedx_sdk.
"""
import os
import re
import sys
...
VERSION = get_version('openedx_sdk', '__init__.py')
...
setup(
    name='openedx-sdk',
    version=VERSION,
    description="""Python SDK for Open edX REST APIs""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Muhammad Faraz Maqsood',
    author_email='faraz.maqsood@arbisoft.com',
    url='https://github.com/openedx/openedx-sdk',
    packages=find_packages(
        include=['openedx_sdk', 'openedx_sdk.*'],
        exclude=["*tests"],
    ),
